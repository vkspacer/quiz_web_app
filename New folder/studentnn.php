...
<body>
	...
	<script>
		function startTimer(duration, display) {
        	var timer = setTimeout(function() {
            		document.getElementById("subquiz").click();
        	}, 120000);
	...
	<button id="subquiz" onclick="test()" style="position:fixed;left:27%;bottom:10%">SUBMIT</button>
	<script>
	function subquiz(){
	r=0;
...
<h2><label for="vol" style="position:fixed;left: 80%;top: 20%;"><div id="tim">Time Remaining<br><span id="time">02:00</span> minutes!</div></label></h2>
