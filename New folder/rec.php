<html>
  ...
  duration: 800
	...
	<b><h1 onClick="window.location.replace('../New Folder/studenthome.html')" style="position:absolute;left:6%;bottom:89%;color:blue;cursor:pointer;">Quizepp</h1></b>
	...
	<?php 
		...
		$sql="SELECT * FROM `attempts` WHERE name='$a' order by score desc;";
